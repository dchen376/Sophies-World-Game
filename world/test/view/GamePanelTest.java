...
/** 
* 
* Method: addPropertyChangeListener(PropertyChangeListener listener) 
* 
*/ 
@Test
...
/** 
* 
* Method: removePropertyChangeListener(PropertyChangeListener listener) 
* 
*/ 
@Test
...
/** 
* 
* Method: getBorderTitle(Border b) 
* 
*/ 
@Test
...
/** 
* 
* Method: shouldProcess(KeyEvent e) 
* 
*/ 
@Test
...
/** 
* 
* Method: putValue(String key, Object value) 
* 
*/ 
@Test
...
/** 
* 
* Method: getAccessibleAt(Point p) 
* 
*/ 
@Test
...
/** 
* 
* Method: setCursor(Cursor cursor) 
* 
*/ 
@Test
...
/** 
* 
* Method: acceptRequestFocus(Component from, Component to, boolean temporary, boolean focusedWindowChangeAllowed, Cause cause) 
* 
*/ 
@Test
...
/** 
* 
* Method: createBuffers(int numBuffers, BufferCapabilities caps) 
* 
*/ 
@Test
...
/** 
* 
* Method: flip(FlipContents flipAction) 
* 
*/ 
@Test
...
/** 
* 
* Method: flipSubRegion(int x1, int y1, int x2, int y2, FlipContents flipAction) 
* 
*/ 
@Test
...
/** 
* 
* Method: registerComponent(JComponent c) 
* 
*/ 
@Test
...
/* 
try { 
   Method method = GamePanel.getClass().getMethod("registerComponent", JComponent.class); 
...
/* 
try { 
   Method method = GamePanel.getClass().getMethod("updateInternalBuffers"); 
   method.setAccessible(true); 
   method.invoke(<Object>, <Parameters>); 
} catch(NoSuchMethodException e) { 
} catch(IllegalAccessException e) { 
...
/* 
try { 
   Method method = GamePanel.getClass().getMethod("invalidate"); 
   method.setAccessible(true); 
   method.invoke(<Object>, <Parameters>); 
} catch(NoSuchMethodException e) { 
} catch(IllegalAccessException e) { 
