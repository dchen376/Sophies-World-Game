...
public class PlayerTest {
  ...
  public void setup() {
    ...
    player1 = new Player(m.getRoomNameIndexMap(), m.getTotalItemsAllowedMap(),
    ...
    player2 = new Player(m.getRoomNameIndexMap(), m.getTotalItemsAllowedMap(),
        m.getItemsDamageMap(), m.getTargetHealth(), m.getTargetLocation(), true, "human", "Sam",
        "Fate", 6, new ArrayList<>(), this.m.getPlayersTargetNameRoomMap(),
        this.m.getPlayersItemsMap(), this.m.getItemsRoomMap(), this.m.getTurnsMap());
    m.getAllPlayers().add(player1);
  }
  ...
  @Test
  public void getPlayersTargetNameRoomMap() {
  ...
  @Test
  public void getRoomNameIndexMap() {
    String expected = "{Amy=The Enlightenment, Sam=Fate}";
    String actual = m.getPlayersTargetNameRoomMap().toString();
    Assert.assertEquals(expected, actual);
  }
